...
import utng.edu.mx.proyectoitext.agenda.AgendaFinalActivity;
import utng.edu.mx.proyectoitext.calcu.MainActivityCalcu;
import utng.edu.mx.proyectoitext.galeria.MenuGaleriaActivity;
...
public class SeleccionModuloActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /////
        LinearLayout fondo = (LinearLayout)findViewById(R.id.liner_del_boton);
        ...
        if(tema==1){
            ...
            if(tema==2){
                ...
                if(tema==3){
                    ...
                    if(tema==4){
                        fondo.setBackgroundColor(getResources().getColor(R.color.fondo));
                    }
                }
            }
        }
        ...
        if (valoresRecibidosLogin.getBoolean("logeo")){
            switch (item.getItemId()) {
                ...
                case R.id.itm_actionbar_menu_ayu_suge_on:
                    ...
                    break;
                case R.id.itm_actionbar_menu_tema:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionModuloActivity.this,TemasActivity.class));
                    break;
                ...
                /**case R.id.itm_actionbar_menu_juego:
                    ...
                    break;
                 */
                case R.id.itm_actionbar_menu_juego_memorama:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionModuloActivity.this, juegos_main.class));

                    //startActivity(new Intent(SeleccionModuloActivity.this, ActivityJuego.class));
                    break;
                case R.id.itm_actionbar_juego_buscamionas:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionModuloActivity.this,MainActivity.class));
                ...
                case R.id.itm_actionbar_cronometro:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionModuloActivity.this,Cronometro.class));

                    //startActivity(new Intent(SeleccionModuloActivity.this, ActivityJuego.class));
                    break;
                case R.id.itm_actionbar_calculadora:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionModuloActivity.this,Calculadora.class));

                    //startActivity(new Intent(SeleccionModuloActivity.this, ActivityJuego.class));
                    break;

                case R.id.itm_actionbar_video_utng:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionModuloActivity.this,VideoActividad.class));

                    //startActivity(new Intent(SeleccionModuloActivity.this, ActivityJuego.class));
                    break;

                case R.id.itm_actionbar_localizador:
                    //Ayuda y sugerencias
                ...
                case R.id.itm_actionbar_agenda:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionModuloActivity.this,AgendaFinalActivity.class));

                    //startActivity(new Intent(SeleccionModuloActivity.this, ActivityJuego.class));
                    break;

                case R.id.itm_actionbar_calculator:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionModuloActivity.this,MainActivityCalcu.class));

                    //startActivity(new Intent(SeleccionModuloActivity.this, ActivityJuego.class));
                    break;

                case R.id.itm_actionbar_galeria:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionModuloActivity.this,MenuGaleriaActivity.class));

                    //startActivity(new Intent(SeleccionModuloActivity.this, ActivityJuego.class));
                    break;
                case R.id.itm_actionbar_visor:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionModuloActivity.this,MainActivityVisor.class));

                    //startActivity(new Intent(SeleccionModuloActivity.this, ActivityJuego.class));
                    break;

                case R.id.itm_actionbar_menu_pinterest:
                    //Ayuda y sugerencias
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://es.pinterest.com/")));
                    //startActivity(new Intent(SeleccionModuloActivity.this, ActivityJuego.class));
                    break;

                case R.id.itm_actionbar_menu_radio:
                    //Ayuda y sugerencias
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://tunein.com/")));
                    //startActivity(new Intent(SeleccionModuloActivity.this, ActivityJuego.class));
                    break;
