package utng.edu.mx.proyectoitext.agenda;
...
public class AgendaFinalActivity extends Activity {
    ...
    */
	...
	/*comente el boton
        private void mostrarToast() {
            ...
            this.boton_acercade.setOnClickListener(new View.OnClickListener() {
    ...
    */
	private void crearEventoCalendario() {
		...
		this.boton_nota.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				crearNotaCalendario();
    ...
    private void crearListado() {
        ...
        this.boton_listado.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                lanzarListado();
            }
        });
