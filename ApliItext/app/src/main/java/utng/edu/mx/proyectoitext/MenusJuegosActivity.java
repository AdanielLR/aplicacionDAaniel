...
public class MenusJuegosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MenusJuegosActivity.this, utng.edu.mx.proyectoitext.gato.Juego.class));
            }
        });
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MenusJuegosActivity.this, utng.edu.mx.proyectoitext.gato.TresEnRaya.class));
            }
        });
