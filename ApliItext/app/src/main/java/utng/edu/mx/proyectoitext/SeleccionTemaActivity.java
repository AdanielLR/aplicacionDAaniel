        ...
        if (valoresRecibidos.getBoolean("logeo")){
            switch (item.getItemId()) {
                ...
                case R.id.itm_actionbar_menu_juego_memorama:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionTemaActivity.this, juegos_main.class));
                    break;

                case R.id.itm_actionbar_juego_buscamionas:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionTemaActivity.this, MainActivity.class));
                    break;
                ...
                case R.id.itm_actionbar_cronometro:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionTemaActivity.this,Cronometro.class));
                ...
                case R.id.itm_actionbar_calculator:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionTemaActivity.this,MainActivityCalcu.class));
                ...
                case R.id.itm_actionbar_calculadora:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionTemaActivity.this,Calculadora.class));

                    //startActivity(new Intent(SeleccionModuloActivity.this, ActivityJuego.class));
                    break;
                case R.id.itm_actionbar_video_utng:

                    startActivity(new Intent(SeleccionTemaActivity.this,VideoActividad.class));

                    break;

                case R.id.itm_actionbar_agenda:
                    //Ayuda y sugerencias
                    startActivity(new Intent(SeleccionTemaActivity.this,AgendaFinalActivity.class));
